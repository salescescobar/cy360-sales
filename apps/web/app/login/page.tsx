  ...
  return (
    <main style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: 360, maxWidth: "100%", padding: 32, borderRadius: theme.radius.card, border: `1px solid ${theme.border}`, background: theme.surface, boxShadow: "0 1px 3px rgba(22,24,29,0.08)" }}>
        <h1 style={{ fontFamily: theme.font.display, fontSize: 24, color: theme.clientDeep, margin: "0 0 4px" }}>CY360 Sales</h1>
        <p style={{ color: theme.textSecondary, fontSize: 14, margin: "0 0 24px" }}>Sign in to your location&apos;s dashboard.</p>
        {error && (
        ...
        <p style={{ color: theme.textSecondary, fontSize: 13, marginTop: 24, marginBottom: 0 }}>
